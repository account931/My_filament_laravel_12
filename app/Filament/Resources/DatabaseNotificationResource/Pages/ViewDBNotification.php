...
class ViewDBNotification extends ViewRecord
{
    ...
    {
        return 'Notification Id: '.$this->record->id.',  Type : '.$this->record->type;
    }
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            // action 2
            Action::make('edit')
                ->label('Edit (forbidden)')
                ->icon('heroicon-o-pencil')
                ->url(fn () => DatabaseNotificationResource::getUrl('edit', ['record' => $this->record])),
            // end action
        ];
    }
