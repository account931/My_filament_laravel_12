        ...
        return Action::make('generateToken')
            ...
            ->action(function (array $data) {
                ...
                if ($token) {
                    ...
                    Notification::make()
                         // ->title($plainToken)
                        ->body('Copy your token, you will never see it again  <sub><b> '.explode('|', $plainToken)[1].'</b></sub>')       // explode() is used as $token comes as "id|token", but saved to db as "token" only,  check here: https://www.codepunker.com/tools/string-converter
