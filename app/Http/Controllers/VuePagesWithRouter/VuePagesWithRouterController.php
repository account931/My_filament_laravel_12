...
namespace App\Http\Controllers\VuePagesWithRouter;
...
class VuePagesWithRouterController extends  Controller
{
    ...
    {   
        ...
        return view('vue-pages-with-router.index'); //->with(compact('name', 'owners'));
    }
