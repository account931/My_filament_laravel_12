...
use App\Models\Venue; // to place controller in subfolder
use Illuminate\Foundation\Auth\Access\AuthorizesRequests;
use Illuminate\Foundation\Bus\DispatchesJobs;
use Illuminate\Foundation\Validation\ValidatesRequests; // my custom Form validation via Request Class (to create new blog & images in tables {wpressimages_blog_post} & {wpressimage_imagesstock})
...
class OwnerController extends Controller
{
    ...
    public function index()
    {
        ...
        // way 1
        $this->authorize('viewAny', Owner::class); // must have, Policy check (403 if fails)
