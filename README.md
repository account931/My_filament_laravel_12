...
Uses library  <code> composer require laravel/socialite </code> OR <code> composer require google/apiclient:^2.0 </code>  to  programatically generate  OAuth 2.0 access token
