...
Route::middleware('auth')->group(function () {
    ...
    // Save/upload images to Google Cloud storage, does not require Socialite login
    Route::get('my-google-storage-images/index', [MyGoogleCloudStorageImagesController::class, 'index'])->name('my.google-cloud-storage.images');  // form with
    Route::post('my-google-storage-images/upload', [MyGoogleCloudStorageImagesController::class, 'uploadGoogleCloudStorageImage'])->name('my-google-cloud-storage.image.upload');  // form to upload file to DB and GDrive + display images
