...
<template>
	<div class="services">
        ...
        <div v-else-if="this.store.passport_api_tokenY != null" class="col-sm-12 col-xs-12 alert alert-info">
		    You are logged  <br>
	    ...
	    makeApiRequestToProtectedRoute() {  
            ...
            .then(dataResponse => {
                ...
                if (dataResponse.data && dataResponse.data.status == "OK" ){ 
					...
					Swal.fire("Done", "Response is loaded (axios) (not Vuex store).", "success");
	        ...
	        .catch(function(err){ 
                ...
                if(err == "Error: Request failed with status code 401" ||  err == "Unauthenticated."){ //if Rest endpoint returns any predefined error
                    ...
                    Swal.fire("Unauthenticated2", "Check Bearer Token", "error");
