        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                     Generate one time link, uses table 'one_time_links'
                ...
                <div class="card-body">
					...
					<div class="alert alert-sucess">
					    <p>
                            <i class="fas fa-user-circle"></i> Hello, <strong>{{Auth::user()->name}}</strong>, here is your one time link
						</p>
                        ...
                        <div class="one-time-link border border-gray-300 m-4 p-4 bg-red-500">
							...
							{{ session()->get('success-link.simpleLink') }} </br></br>
                            <a href="{{ session()->get('success-link.simpleLink') }}" target="_blank" rel="noopener noreferrer"> 
