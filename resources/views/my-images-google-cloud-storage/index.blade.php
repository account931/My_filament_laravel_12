    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                Images Google Cloud Storage, do NOT require login via Socialite to get access_token and refresh_token, as it loads to a predefined bucket.
                <br>
                ...
                <div class="alert alert-info alert-dismissible fade show" role="alert">
                    ...
                    <div>
                        <p class="bg-red-500 border-2 border-black hover:bg-blue-700 text-black font-bold py-2 px-4 rounded">
                            ...
                            <span style="font-size: smaller;">it saves the user_id to local DB, but in Google Cloud it does not matter who you are, it just saves to common bucket registered to di***1@gmail.com</span>
                        </p>
                        <br>
            ...
            <div>
                <p class="mb-4 p-4 border border-success  text-success rounded"> Google Storage images for {{ Auth::user()->name }} </p>
                        ...
                        <div class="col-4"> <!-- Bootstrap CSS class-->
                           ...
                           <!-- Delete button from  -->
                            <form action="{{ route('my-google-cloud-storage.image.delete',  $item->id ) }}" method="POST" >
                               ...
                               <button type="submit" class="btn btn-danger rounded" onclick="return confirm('Are you sure you want to delete?')"> Delete </button> 
                           </form>
