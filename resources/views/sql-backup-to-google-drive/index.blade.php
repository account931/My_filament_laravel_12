    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-12">
            <div class="card">
                ...
                <span class="small text-danger">Note: it is not Queue job but console command (it is for convenience, if you wish switch to Job variant in controller)<br></span>
